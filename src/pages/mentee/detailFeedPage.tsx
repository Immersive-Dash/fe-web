            ...
            <div className="grid grid-cols-12 items-center px-4">
                ...
                <div className="col-span-6 flex justify-end">
                    <div className="flex flex-col gap-2">
                        <div>
                            <h1 className="text-xl font-semibold">phone : <span className='font-normal'> 085729830543</span>  </h1>
                        </div>
                        <div>
                            <p className="text-xl font-semibold">telegram : <span className='font-normal'>  @udinasep</span></p>
                        </div>
                        <div>
                            <p className="text-xl font-semibold">discord : <span className='font-normal'> @udinasep#123</span> </p>
                        </div>
                        <div>
                            <p className="text-xl font-semibold">email : <span className='font-normal'> udinasep@gmail.com</span></p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div className="px-6 py-6 lg:px-8">
                                    ...
                                    <form className="space-y-4" action="#">
                                        ...
                                        <div className="flex gap-2 py-2 justify-end">
                                            ...
                                            <button type="submit" className=" text-white bg-[#3E31DF] focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-8 py-2.5 text-center">Add</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
